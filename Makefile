...
zip:
	zip 01429167_project.zip project/project/seminar_test1.dl project/project/seminar_test2.dl project/project/seminar_test3.dl project/project/seminar_test4.dl project/project/seminar_test5.dl project/project/seminar_guess.dl project/project/seminar_check.dl project/project/network_test1.dl project/project/network_test2.dl project/project/network_test3.dl project/project/network_test4.dl project/project/network_test5.dl project/project/network_test6.dl project/project/network_test7.dl project/project/network_test8.dl project/project/test_network.dl project/project/network.dl project/project/cbd.hyp project/project/cbd_cstr.dl project/project/cbd_fault.obs project/project/cbd_fault_m1_ok.obs project/project/cbd_fault_c1_ab.obs project/project/cbd_fault_m1m2_ab.obs project/project/abd.hyp project/project/abd_cstr.dl project/project/abd_network.dl project/project/abd_fault.dl project/project/abd_fault.obs project/project/abd_fault_m1_wary.obs project/project/abd_fault_empty.obs
